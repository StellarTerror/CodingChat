...
export function Header(props: {language_change: (language: string) => void, is_running: boolean, run_code: () => void}) {
    var run_button = props.is_running ? 
        ...
        <button onClick={props.run_code} type="button" className="btn" color="inherit">
                    ...
                    <div className="d-flex flex-row">
                        <div className="nav-item">
                            <select
                                ...
                                defaultValue={"cpp"}
                                color="inherit"
                                onChange={(event: React.ChangeEvent<HTMLSelectElement>) => props.language_change(event.target.value as string)}
                            >
                        ...
                        <div className="nav-item">
                            <button type="button" className="btn" color="inherit" onClick={() => window.location.href = "/"}>
                                <div style={{color: "white"}}>
                                    退室
                                </div>
                            </button>
